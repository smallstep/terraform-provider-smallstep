		...
		Steps: []helper.TestStep{
			{
				...
				Check: helper.ComposeAggregateTestCheckFunc(
					...
					helper.TestCheckNoResourceAttr("data.smallstep_managed_radius.my_rad", "reply_attributes.0.value_from_extension"),
					helper.TestCheckResourceAttr("data.smallstep_managed_radius.my_rad", "reply_attributes.1.name", "Tunnel-Private-Group-ID"),
					helper.TestCheckResourceAttr("data.smallstep_managed_radius.my_rad", "reply_attributes.1.value_from_extension", "2.5.4.11"),
